...
#define IPS114_USE_SOFT_SPI (0) // 默认使用硬件 SPI 方式驱动（推荐）
#if IPS114_USE_SOFT_SPI         // 软件 SPI 驱动接口（当前暂不支持）
//====================================================软件 SPI 驱动====================================================
// 暂不支持
//====================================================软件 SPI 驱动====================================================
#else
//====================================================硬件 SPI 驱动====================================================
#define IPS114_SPI_SPEED ((uint32)10 * 1000 * 1000U) // 硬件 SPI 速率 这里设置为系统时钟二分频
