...
{
    /* 速度环初始化，默认提供一组安全基础参数 */
    pid_speed_init(&PID.left_speed, 120.0f, 15.0f, 0.0f, 9000.0f, 9000.0f);
    pid_speed_init(&PID.right_speed, 120.0f, 15.0f, 0.0f, 9000.0f, 9000.0f);
...
void control_apply_config(void)
{
    ...
    app.start.fuya_ground_percent = clamp_config_percent(app.start.fuya_ground_percent);
